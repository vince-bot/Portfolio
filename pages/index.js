...
export default function Home() {
              ...
              <div className="container">
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-700 text-md leading-relaxed">
                    As a <b className="text-[#1e3a5f]">Front End Developer</b>,
                    I craft fast, responsive, and user-focused web applications.
                    I’m passionate about clean design, seamless functionality,
                    and optimizing performance for the best user experience.
                    Collaboration, problem-solving, and attention to detail
                    drive every project I build.
                  </p>
                  <div className="w-full flex flex-col lg:flex-row mt-6 gap-8">
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-gray-700 text-md leading-relaxed">
                        I'm a{" "}
                        <b className="text-[#1e3a5f]">Frontend Developer</b>{" "}
                      ...
                      <p className="text-gray-700 text-md leading-relaxed mt-5">
                        ...
                        frameworks like React.js and Next.js. I create
                        responsive, user-friendly interfaces that enhance user
                        experience across devices.
                      </p>
                      <p className="text-gray-700 text-md leading-relaxed mt-5">
                        I collaborate closely with designers and back-end
                        developers to deliver high-quality web solutions that
                        meet client needs and industry standards.
                      </p>
                      <p className="text-gray-700 text-md leading-relaxed mt-5">
                        With a keen eye for detail and a passion for innovation,
                        I strive to stay updated with the latest web development
  ...
  "
            ...
            <section
              id="projects"
              className="flex flex-col bg-white p-5 xl:p-10"
            >
              <div className="container">
                ...
                <div className="space-y-3 pb-5">
                  <p className="text-gray-700 text-md ">
                    ...
                    hope they provide you with a better understanding of the
                    wide range of services I offer. I have hands-on experience
                    working with the latest technologies like React, Next.js,
                    TailwindCSS, and JavaScript, and I have built several
                    websites from scratch.
                  </p>
                  <p className="text-gray-700 text-md pb-4">
                    Additionally, I integrate headless CMS solutions to enable
                    scalable and flexible content management. I also optimize
                    site performance, SEO, and Core Web Vitals to ensure
                    top-tier user engagement and visibility across search
                    engines.
                  </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row w-full gap-x-10">
                  ...
                  <div className="flex flex-col h-auto w-full md:w-1/2 justify-between">
                    <div className="flex flex-col text-white pt-5 md:pt-0">
                      <p>
                        If you have any questions or queries about me and my
                        work, get in touch with me with any issues regarding my
                        services. Please feel free to contact me. You can use
                        the form below or send me an email. I will definitely
                        reach out to you.
                      </p>
